import pytest
# from viktor.mine_sweeper.game_session import GameSession
...
def test_win():
    ...
    game_session = game.GameSession(2, 1, 0)
    game_session.mines = [(0, 0)]
    assert game_session.win() is False

    game_session.save_guess((1, 0))

    assert game_session.win() is True